...
> The RMSE of this is 0.4864136, meaning that we are potentially off by that amount in the same units of lprice in our test data. The lower this number, the better. When we apply the exponent to this in order to cancel out our logarithm, we get that we would expect to be off by $1.63.
